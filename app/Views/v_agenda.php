        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="nama_kegiatan" rows="4" class="form-control" required></textarea>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Nama Kegiatan</label>
                    <textarea name="nama_kegiatan" rows="4" class="form-control" required><?= $value['nama_kegiatan'] ?></textarea>
                </div>
...
<div class="modal fade" id="modal-delete<?= $value['id_agenda'] ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Apakah Ingin Menghapus Data Agenda ? <br>
               <b> <?= $value['nama_kegiatan']?> </b>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                <a href="<?= base_url('Agenda/DeleteData/' .$value['id_agenda']) ?>" type="submit" class="btn btn-danger">Delete</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
